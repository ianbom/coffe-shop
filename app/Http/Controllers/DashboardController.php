...
foreach ($usersWithOrderCount as $userOrder) {
    ...
    if ($user) {
        ...
        return view('dashboard_admin', compact('totalUser', 'totalProducts', 'totalOrder', 'totalCoffe','totalNon', 'productName',
        'totalPurchased', 'totalSalesPerProduct', 'totalSales', 'productName', 'namaProduk', 'totalSold', 'userNames', 'orderCounts','coffeeSold','nonCoffeeSold', 'totalEarning'));
    }
}
